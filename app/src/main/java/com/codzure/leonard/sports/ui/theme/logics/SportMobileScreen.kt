...
import com.codzure.leonard.sports.R
    ...
    Scaffold(
        ...
        if (contentType == SportsContentType.ListAndDetail) {
            SportsListAndDetail(
                ...
                onClick = {
                    viewModel.updateCurrentSportList(it)
                },
...
fun SportsListPreview() {
    SportsTheme {
        Surface {
            SportsList(
                sports = LocalSportsDataProvider.getDefaultSportData(),
                onClick = {},
            )
        }
    }
...
fun SportsListAndDetailsPreview() {
    SportsTheme {
        Surface {
            SportsListAndDetail(
                sports = LocalSportsDataProvider.getDefaultSportData(),
                selectedSport = LocalSportsDataProvider.getDefaultSportData().getOrElse(0) {
